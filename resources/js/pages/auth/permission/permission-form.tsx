...
export default function PermissionFormModal({ isEditing, permission, buttonLabel = "Add New Permission", onSuccess }: PermissionModalProps) {
  ...
  // Update form data when permission prop changes or modal opens
  useEffect(() => {
