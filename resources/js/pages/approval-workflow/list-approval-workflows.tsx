...
export default function ApprovalWorkflows({ flash }: IndexProps) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="container mx-auto p-4">
                ...
                <h2 className="text-xl font-bold mb-4">All Workflows</h2>
                <div className="flex justify-end mb-6">
                    <Link
                        href={route('approval-workflow.create')}
                ...
                <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <DataTable columns={columns} ajaxUrl="/approval-workflows" />
                </div>
            </div>
        </AppLayout>
    );
